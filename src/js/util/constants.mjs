...
constants.TARGETGROUP_BLIND = 'TARGETGROUP_BLIND';
...
constants.TARGETGROUPS = [constants.TARGETGROUP_VISUAL_IMPAIRMENT, constants.TARGETGROUP_BLIND, constants.TARGETGROUP_MOTOR_IMPAIRMENT, constants.TARGETGROUP_COGNITIVE_IMPAIRMENT];

constants.ANSWER_NOT_APPLICABLE = 'ANSWER_NOT_APPLICABLE';
...
constants.COMMENTS_OBJECT_ID = "COMMENTS_OBJECT_ID";
